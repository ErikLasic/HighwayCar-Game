...
public class WorldUnitsGame extends ApplicationAdapter {
    ...
    public void render() {
        ...
        batch.begin(); { //Display background 640x480
            batch.draw(backgroundImage, 0, 0, hudViewport.getWorldWidth(), hudViewport.getWorldHeight());
        }
        batch.end();
        ...
        if (carHealth > 0 && fuelPercentage > 0) {
            ...
            batch.begin();
            {
                ...
                font.draw(batch, "Game ended!", hudViewport.getWorldWidth() /2f, hudViewport.getWorldHeight() / 2f);
                font.setColor(Color.BLACK);
                font.draw(batch, "SCORE:" + counter, hudViewport.getWorldWidth() /2f, hudViewport.getWorldHeight() /3f);
            }
            batch.end();
        }
        ...
        {    // brackets added just for indent
            ...
            font.draw(batch, "" + fuelPercentage, hudViewport.getWorldWidth() - 50, hudViewport.getWorldHeight() - 20);
            font.setColor(Color.ORANGE);
            font.draw(batch, "" + carHealth, 20, hudViewport.getWorldHeight() - 20);
            font.setColor(Color.GREEN);
            font.draw(batch, "" + counter, hudViewport.getWorldWidth()/2f - 25 , hudViewport.getWorldHeight() - 20);
        }
        batch.end();
    }
    private void draw() {
        ...
        font.draw(batch,
                oneWorldUnit,
                20f,
                hudViewport.getWorldHeight() - 110f);
    }
